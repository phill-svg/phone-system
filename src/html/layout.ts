...
const NOTIFY_JS = [
  ...
  '          var fbm = String(c.number || "").indexOf("messenger:") === 0;',
  '          fire(fbm ? "New Facebook message" : "New SMS", (c.name || (fbm ? "Facebook user" : c.number)) + ": " + (c.last_body || ""), "/admin/messages?to=" + encodeURIComponent(c.number), "msg:" + c.number);',
  '        }',
